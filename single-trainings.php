...
<main class="main training general">
  ...
  <section class="training__content general--single-narrow">
    ...
    <a href="mailto:terry.boes@icf.com?subject=Customized subject goes here" class="training__cta btn btn--blue" title="Click here to access training">Access Training</a>
  </section>
</main><!-- .Main content -->
<?php get_footer(); ?>