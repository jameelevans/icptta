...
<p class="p__body">Additionally, an activation notification process – including the triggering mechanism and method of notification–should be determined. Who needs to be contacted? By whom? When? Once the primary points of contact are activated, those individuals will deploy additional agency personnel.</p><br/>
...
<p class="p__body">The FAC is a secure facility established to support victims and their families as well family and loved ones of those who are missing or known to be deceased. “Family” is not limited to a legal next-of-kin relationship and may include immediate family, friends, partners, and/or distant relatives. The FAC is different from an FRC in that the FAC provides services to meet the immediate needs of those identified as victims by lead law enforcement and prosecution entities, in coordination with the lead victim service agency.</p><br/>
...
<p class="p__body">Financial donations are likely to come in quickly - sometimes to a variety of funds. Jurisdictions need to develop a trauma-informed, victim-centered system to manage these funds. Jurisdictions will want to consider working with a designated 503c. organization to manage donated funds and identify personnel and organizations with knowledge of donation and disbursement consequences.</p><br/>
